                                          ...
                                          float res_roll, bool no_sfx )
{
    ...
    if( !sound.empty() && !silent && !no_sfx ) {
        sfx::play_variant_sound( soundfxid, soundfxvariant, sfx::get_heard_volume(p), 0, sfx::get_heard_angle(p));
    }
                                 ...
                                 bool bash_floor, bool no_sfx )
{
    ...
    const auto ter_furn = bash_ter_furn( p, str, silent, destroy, bash_floor, resistance_roll, no_sfx );
    ...
    if ( !ter.open.empty() && ter.open != "t_null" ) {
        ...
        if (openable >= 0) {
            if( !check_only ) {
                ...
                sfx::play_variant_sound( "vehicle", "vehicle_open_door", sfx::get_heard_volume(veh->global_pos3()));
            }
            sfx::play_variant_sound( "vehicle", "vehicle_open_door", sfx::get_heard_volume(veh->global_pos3()));
            return true;
        }
